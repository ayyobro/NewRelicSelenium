...
.then(function () {
  log('get "http://pdstest.impulsecreative.com/twenty-sixteen-conference"');
  return $browser.get("http://pdstest.impulsecreative.com/twenty-sixteen-conference");
})
...
.then(function (el) {
  el.clear();
  el.sendKeys("Derek Foster\'s Company"); })
...
.then(function (el) {
  el.clear();
  el.sendKeys("123 Random Address"); })
...
.then(function (el) {
  el.clear();
  el.sendKeys("http://stackoverflow.com"); })

.then(function () {
  log('setElementSelected "//div[1]/form[1]/div[1]/div/div[2]/fieldset/div[1]/div[8]/div/select//option[2]"');
  return $browser.waitForAndFindElement(By.xpath("//div[1]/form[1]/div[1]/div/div[2]/fieldset/div[1]/div[8]/div/select//option[2]"), DefaultTimeout); })
.then(function(el) { return el.isSelected(); })
.then(function(bool) { if (!bool) { $browser.actions().click($browser.findElement(By.xpath("//div[1]/form[1]/div[1]/div/div[2]/fieldset/div[1]/div[8]/div/select//option[2]"))).perform(); } })

.then(function () {
  log('setElementSelected "//div[1]/form[1]/div[1]/div/div[2]/fieldset/div[1]/div[9]/div/select//option[3]"');
  return $browser.waitForAndFindElement(By.xpath("//div[1]/form[1]/div[1]/div/div[2]/fieldset/div[1]/div[9]/div/select//option[3]"), DefaultTimeout); })
.then(function(el) { return el.isSelected(); })
.then(function(bool) { if (!bool) { $browser.actions().click($browser.findElement(By.xpath("//div[1]/form[1]/div[1]/div/div[2]/fieldset/div[1]/div[9]/div/select//option[3]"))).perform(); } })
...
.then(function (el) {
  el.clear();
  el.sendKeys("jimbob@gmail.com"); })

.then(function () {
  log('setElementText "attendee_two_name"');
  return $browser.waitForAndFindElement(By.name("attendee_two_name"), DefaultTimeout); })
.then(function (el) {
  el.clear();
  el.sendKeys("Stephanie Stars"); })

.then(function () {
  log('setElementText "attendee_two_email"');
  return $browser.waitForAndFindElement(By.name("attendee_two_email"), DefaultTimeout); })
.then(function (el) {
  el.clear();
  el.sendKeys("starstruck@gmail.com"); })
...
.then(function () {
  log('setElementSelected "//div[@class=\'form-horizontal\']/div[10]/div[1]/select//option[3]"');
  return $browser.waitForAndFindElement(By.xpath("//div[@class=\'form-horizontal\']/div[10]/div[1]/select//option[3]"), DefaultTimeout); })
.then(function(el) { return el.isSelected(); })
.then(function(bool) { if (!bool) { $browser.actions().click($browser.findElement(By.xpath("//div[@class=\'form-horizontal\']/div[10]/div[1]/select//option[3]"))).perform(); } })
